...
## ⚠️ Attribution-Pflicht

Wenn du diese Software:
- **Forkst** → Copyright-Notice in allen Dateien behalten
- **Modifizierst** → Original-Autor Tuc2300 nennen
- **Binaries verteilst** → LICENSE + Copyright in Dokumentation
- **Rebrandest** → Namen "League Account Manager" nicht für Marketing nutzen

## 🚫 Was nicht erlaubt ist:
- ❌ Copyright entfernen
- ❌ Als eigenes Projekt ausgeben
- ❌ Namen für eigene Marke nutzen
